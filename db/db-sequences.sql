...
-- SEQUENCE: public.lists_user_id_seq

-- DROP SEQUENCE public.lists_user_id_seq;

CREATE SEQUENCE public.lists_user_id_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
...
ALTER SEQUENCE public.lists_user_id_seq
    OWNER TO todo_admin;
